        ...
        <ul>
            <li>
                ...
                <div class="highlight">
                    <!-- eslint-disable -->
                    <code>
                        &lt;<span class="pl-ent">vue-bank-card </span>
                        <span class="pl-e">is-new</span>
                        /&gt;
                    </code>
                    <!-- eslint-enable -->
                </div>
            ...
            <li>
                ...
                <div class="highlight">
                    ...
                    <code>
                        &lt;<span class="pl-ent">vue-bank-card </span>
                        :<span class="pl-e">number</span>=<span><span class="pl-pds">"</span>number<span class="pl-pds">"</span></span>
                        /&gt;
                        <br /> <br />
...
export default {
    ...
    data() {
        return {
            ...
            imagesPath: "images/",
            readmePath:
                "https://github.com/shawon3719/vue-bank-card-input.git/blob/master/README.md",
            number: {
                first_six: "553691",
                last_four: "3333"
            },
